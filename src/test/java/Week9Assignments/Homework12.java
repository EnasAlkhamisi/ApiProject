...
//            (Use Pojo)
    ...
    public void Test() {
        ...
        int id = 3000;
        petcategoryPojo category = new petcategoryPojo(3,"Duck");
        ArrayList<String> photoUrlsList = new ArrayList<>();
        photoUrlsList.add("ssss");
        pettagPojo tags = new pettagPojo(55,"Duck");
        ...
        expectedData.getCategory().setName("Bird");
        expectedData.setName("Dove");
        ...
        response = given().delete(url+"/3000");
        response.prettyPrint();
